...
свободный стол,
бот на основе результатов уже сыгранных матчей турнира оценивает уровень всех игроков, а затем выбирает среди свободных в данный момент
игроков пару игроков с максимально близким друг к другу уровнем игры, которые ещё не играли между собой, и ставит их за стол.
...
Ранг игрока, который никому не проиграл — 1. Ранг каждого из оставшихся игроков — на единицу больше ранга самого слабого игрока, которому
он проиграл. Например, в описанном выше примере, Антон и Борис будут иметь ранг 1, Владимир ранг 2, Григорий ранг 3, а Денис и Евгений — 4.
