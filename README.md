...
Вот пример того, как выглядит таблица какого-то завершённого турнира:
[[!example.png]]

Красными линиями отмечен наиболее плотный по доле сыгранных матчей кусок в середине итоговой таблицы. Это подтверждает то, что игроки
